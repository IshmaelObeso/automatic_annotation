...
button1 = tk.Button(text='Click me to Auto Annotate', command=lambda:
     batch_process_to_auto_annotation.main(entries[0].get(), entries[1].get()), bg='brown', fg='white').pack()
